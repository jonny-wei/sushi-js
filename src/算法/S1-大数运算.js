 ...
 * @returns
 */
const floatNumberAdd1 = function (num1, num2) {
 ...
 * @returns
 */
const floatNumberAdd2 = function (num1, num2) {
 ...
 * @returns
 */
const largeNumberAdd3 = function (num1, num2) {
 ...
 */
const largeNumberAdd4 = function (num1, num2) {
...
largeNumberAdd4("9007199254740991", "1234567899999999999");

/**
 * 正负整数与浮点数大数加减运算
 * @param {String} a
 * @param {String} b
 * @param {String} method 运算方式
 */
const addLargeNumber = (a = "", b = "", method = "+") => {
  ...
  let calMethod = true; // 运算方式,true为加法运算,false为减法运算
  let allAgentive = false; // 是否需要加负号
  ...
  if (a.includes("-") && b.includes("-")) {
    ...
    if (+tempX > +tempY) {
      subtracted = tempX;
      minus = tempY;
      allAgentive = a.includes("-");
    } else {
      // 默认为x - y，如果改为y - x需要给结果添加负号
      subtracted = tempY;
      minus = tempX;
      allAgentive = b.includes("-");
    }
  }
